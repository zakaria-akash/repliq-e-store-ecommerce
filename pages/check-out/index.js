  ...
  return (
    <div className="container my-5 mx-auto">
      <div className="row m-0 p-0">
        <div className="col-sm-12 my-2 mx-auto text-white d-flex justify-content-center">
          <Image
            src="/images/logo.jpg"
            alt="logo"
            width="100"
      ...
      <main className="row my-0 mx-auto">
        <div className="text-center">
          <h2 className="category-title">Checkout form</h2>
          <p>
